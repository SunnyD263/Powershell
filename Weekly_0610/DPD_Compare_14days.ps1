...
if ( $Row -ne 0) {
  ...
  if (Test-Path $xlsxFile) {
    ...
    $Mail.Cc = $EmailCopy
    $Mail.Subject = $xlsxF
    $Mail.Body = 'Pravidelny report nedokoncenych DPD preprav za posledni 4 tydny bez poslednich 2 tydnu'
...
$MyFileName = 'ParcelShop_14days.ps1'

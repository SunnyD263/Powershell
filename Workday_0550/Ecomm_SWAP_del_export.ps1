$SQLDBName = "DPD_DB"
$table="SWAP_Dvc_View_Export"
$path="\\10.47.17.20\pmi-dbo\Ecomm\SWAP_Delivered\"
...
if ( $Row -ne 0) {
  ...
  if (Test-Path $xlsxFile) {
    ...
    $Mail.To = $Email
    $Mail.Cc = $EmailCopy
    $Mail.Subject = 'Pravidelny report nenaskenovanych zarizeni ze SWAP zasilek'
    $Mail.Body = 'Pravidelny report nenaskenovanych zarizeni ze SWAP zasilek'
  ...
  [System.Runtime.Interopservices.Marshal]::ReleaseComObject($Outlook) | Out-Null
    ...
    $Mail.Cc = $EmailCopy
    $Mail.Subject = 'Pravidelny report nenaskenovanych zarizeni ze SWAP zasilek'
    $Mail.Body = 'Zadna naskenovana zarizeni'
    $Mail.Send() 
...
$MyFileName = "Ecomm_SWAP_Dvc_miss.ps1"

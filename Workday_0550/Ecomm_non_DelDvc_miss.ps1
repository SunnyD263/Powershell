...
$path="\\10.47.17.20\pmi-dbo\Ecomm\NonDlv_device_miss\"
$file="PMINONDELMISSDVC_"
...
if ( $Row -ne 0) {
  ...
  if (Test-Path $xlsxFile) {
    ...
    $Mail.To = $Email
    $Mail.Cc = $EmailCopy
    $Mail.Subject = 'Pravidelny report chybejicich zarizeni z nedoruceny zasilek'
    $Mail.Body = 'Pravidelny report chybejicich zarizeni z nedoruceny zasilek'
...
$MyFileName = 'Ecomm_non_DelDvc.ps1'

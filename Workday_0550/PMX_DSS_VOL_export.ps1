...
$table="DSSMITH_VOL_View"
$path="\\10.47.17.20\pmi-dbo\PMX\VOL\"
$file="PMX_VOL_"
...
$SQL= "SELECT *  FROM [dbo].[DSSMITH_VOL_View] WHERE convert(varchar,[Process Start Date],112) = " + $date.ToString('yyyyMMdd')

$SqlConnection = New-Object System.Data.SqlClient.SqlConnection
$SqlConnection.ConnectionString = "Server = $SQLServer; Database = $SQLDBName; User Id=$uid;Password=$passw ;"
$SqlCmd = New-Object System.Data.SqlClient.SqlCommand
 $SqlQuery = "SELECT *  FROM [dbo].[DSSMITH_VOL_View] WHERE convert(varchar,[Process Start Date],112) =" + $date.ToString('yyyyMMdd')

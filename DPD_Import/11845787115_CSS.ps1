$filemask =  'STATUSDATA_jkahf75a_D'
        ...
        ForEach ($rec in $data) 
            {
              ...
              elseif ($Reference.length -le 14)
                ...
                VALUES  ('$($rec.PARCELNO)','$($rec.SCAN_CODE)','$ChngDT','$($rec.SERVICE)','$($rec.CONSIGNEE_ZIP)','$Reference','$($rec.RECEIVER_NAME)','DPD-CSS','Import')"
...
$MyFileName = "24345787115_E-comm.ps1"

$filemask =  'STATUSDATA_KN24345787_D'
        ...
        ForEach ($rec in $data) 
            {
              ...
              elseif ($Reference.length -le 14)
                ...
                VALUES('$($rec.PARCELNO)','$($rec.SCAN_CODE)','$ChngDT','$($rec.SERVICE)','$($rec.CONSIGNEE_ZIP)','$Reference','$($rec.RECEIVER_NAME)','DPD-EcomVer','Import')"
